...
begin
  ...
  begin
    ...
    Items.Add(Format(lisCOdefault,[LCLPlatformDirNames[GetDefaultLCLWidgetType]]));
...
//  IDEDialogLayoutList.ApplyLayout(Self, 830, 570);
...
begin
  ...
  if LCLInterfaceRadioGroup.ItemIndex=0 then    // Default
    AProfile.TargetPlatform  :=GetDefaultLCLWidgetType
  else
